                ...
                <div class="projects">
                    <div class="primer-card">
                        <div class="primer-card-header">
                            <h3> Filmes que o actor participou   </h3>
                            <button onclick="window.location.href='CadastrarFilmeAtor.jsp'"> Atribuir actor ao filme <span class="las la-arrow-right"></span> </button>
